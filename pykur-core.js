(function(){
  ...
  const ACHIEVEMENTS={
    ...
    master_secrets:{title:"Maître des secrets",description:"Découvrir tous les secrets et easter eggs du tracker.",category:"FINAL",icon:"./images/succes/FINAL/trackerabsolu.jpg"},
    true_100:{title:"Le vrai 100%",description:"Débloquer Tracker absolu et Maître des secrets.",category:"FINAL",icon:"./images/succes/FINAL/trackerabsolu.jpg"},
  ...
  function defaultData(){
    return {
      ...
      settings:{
        ...
        shortcutsEnabled:true,livingEvents:true,helpAutoDisabled:false,adminAutoCloseAfterAction:false,adminQuickReopenSeconds:45,keybinds:defaultKeybinds()
      },
  ...
  function makeStore(){
    ...
    return {active:id,optionsShared:false,sharedSettings:defaultData().settings,profiles:{[id]:{name:"Pykur principal",data:defaultData()}}};
  }
